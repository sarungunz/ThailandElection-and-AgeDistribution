...
ผลการประมาณในเบื้องต้น ให้ข้อสังเกตว่า มีเพียงพรรคประชาธิปัตย์และพรรคภูมิใจไทย (จากท้ังห้าพรรคการเมืองที่นำมาวิเคราะห์) เท่านั้น ที่สัดส่วนของคะแนนเสียงที่ได้รับเป็นไปในทิศทางเดียวกันกับสัดส่วนของประชากรที่ถูกนิยามว่าเป็น `คนรุ่นใหม่` ซึ่งข้อสังเกตดังกล่าวก็ยังคงไม่มีการเปลี่ยนแปลง ถึงแม้ว่าเราจะปรับเปลี่ยนช่วงความกว้างของนิยามคำว่า `คนรุ่นใหม่` ในขณะที่พรรคที่เหลืออีกสามพรรค คือ พรรคพลังประชารัฐ พรรคเพื่อไทย และพรรคอนาคตใหม่ นั้น ผลการประมาณในเบื้องต้น ให้ข้อสังเกตว่า สัดส่วนของคะแนนเสียงที่ได้รับเป็นไปในทิศทางตรงข้ามกันกับสัดส่วนของประชากรที่ถูกนิยามว่าเป็น `คนรุ่นใหม่`

`
** หมายเหตุ: 1. ข้อสังเกตข้างต้น มิได้บ่งชี้ว่า ประขากรที่ถูกนิยามว่าเป็น `คนรุ่นใหม่` ในบทความนี้ จะเลือกหรือไม่เลือกพรรคการเมืองเหล่าน้ันจริงๆ เนื่องจากเราไม่สามารถดึงข้อมูลการเลือกตั้งรายบุคคลออกมาทำการวิเคราะห์ได้ 2. ผลการวิเคราะห์ที่ได้ในที่นี้ เป็นเพียงแค่ข้อสังเกตเบื้องต้น และทำขึ้นเพื่อนำมาใช้ประโยชน์ในการเรียนการสอนเท่าน้ัน ไม่่อาจเป็นข้อสรุปหรือข้อคิดเห็นทางการเมืองหรือนำไปใช้อ้างอิงใดๆได้ **
`
