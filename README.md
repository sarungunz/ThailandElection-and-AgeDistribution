# Thailand Election 2019 & Age Distribution of Voters
...
Interactive visualization ต่อไปนี้ แสดงความสัมพันธ์ (ในเบื้องต้น) ระหว่างสัดส่วน (%) ของคะแนนเสียงที่แต่ละพรรคได้รับในระดับจังหวัด กับ สัดส่วน (%) ของ "คนรุ่นใหม่" ต่อประชากรผู้มีสิทธิ์ออกเสียงทั้งหมดในจังหวัดนั้นๆ
...
- ในส่วนสุดท้ายของบทความนี้ เราจะมาลองทำ Interactive Dashboard เพื่อช่วยในการวิเคราะห์ผลการเลือกต้ังในเบื้องต้น
